        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$customer->birth_month ? date('F', mktime(0, 0, 0, $customer->birth_month, 1)) : ''}}
</td>
                    <td>{{$customer->birth_day}}</td>
                    <td>{{$customer->created_at}}</td>
                    <td>
                        <a href="{{ route('customers.edit', $customer) }}" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                        <!-- <a href="{{route('customers.destroy', $customer)}}" class="btn btn-danger btn-delete"><i class="fas fa-trash"></i></a> -->
