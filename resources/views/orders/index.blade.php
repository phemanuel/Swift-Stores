        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('orders.show', $order) }}" class="btn btn-info btn-sm" >{{ __('order.View') }}</a>
                        <a href="{{ route('orders.print_receipt', $order) }}" class="btn btn-primary btn-sm" target="_blank">{{ __('order.Print_Receipt') }}</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
